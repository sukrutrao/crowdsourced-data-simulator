...
# 8 people answering 1000 questions, each with 10 options, where exactly
# one is correct
...
types_of_people = [PeopleTypes(50, 0.1, 0.3), PeopleTypes(
    40, 0.4, 0.6), PeopleTypes(10, 0.6, 0.85)]
...
# simulated data is stored question-wise, with a comma-separated set of
# correct options
data_simulator.write_to_csv(
    'crowd.csv', data, mode="value", order_by="question")
